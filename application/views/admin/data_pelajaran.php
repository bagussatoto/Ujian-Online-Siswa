        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              ...
              <a href="<?php echo base_url() ?>admin/form-data-pelajaran" class="btn btn-default float-right form-add-new"><i class="fa fa-plus"></i> Add New</a>
            </div>
            <!-- /.card-header -->
            <div class="card-body">
                        ...
                        <td>
                          <div class='btn-group'>
                            ...
                            <div class='dropdown-menu' role='menu' x-placement='top-start' style='position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(67px, -165px, 0px);'>
                              <a class='dropdown-item edit' href='".base_url('admin/form-data-pelajaran-edit/'.$value->id_pelajaran)."'>Edit</a>
                              <!--<a class='dropdown-item delete' href='".base_url('admin/data-pelajaran-delete/'.$value->id_pelajaran)."'>Delete</a>-->
                            </div>
                          </div>
                        </td>
                      </tr>
